...
import { extractPaymentBreakdown, relatePaymentAdjustment } from '../payroll-payments.mjs';
...
test('noviembre 2025: cantidad pendiente negativa se relaciona con NOPAGA festivo del mes', () => {
  ...
  `);
  assert.deepEqual(breakdown, { transfer1: 2247.01, transfer2: null, pendingAmount: -41.8, netTotal: 2205.21 });
