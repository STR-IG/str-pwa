...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const isFirstDegree = queryType === "intervencion_quirurgica_primer_grado";
    const flexibleDays = isCohabitant || isFirstDegree;
