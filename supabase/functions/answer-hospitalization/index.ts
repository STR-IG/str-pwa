...
Deno.serve(async(req:Request)=>{
  ...
  try{
    ...
    const isSecondGrade=queryType==="hospitalizacion_familiar_segundo_grado";
    const usesDocumentation=isFirstGrade||isSecondGrade;
