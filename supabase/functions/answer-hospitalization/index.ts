...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    console.error("Unexpected answer-hospitalization error", error instanceof Error ? error.message : "unknown");
