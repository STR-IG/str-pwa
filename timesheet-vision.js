(() => {
  ...
  const FIELD_MAP = {
    rotation: 'analysis-rotation', meals: 'analysis-meals', night: 'analysis-night', shift: 'analysis-shift',
    holiday: 'analysis-holiday', shift12: 'analysis-shift12', holidayDiets: 'analysis-holidayDiets', vacation: 'analysis-vacation'
  };
  ...
  async function getSession() {
    ...
    const client = mod.createClient(SUPABASE_URL, SUPABASE_PUBLISHABLE_KEY, { auth: { detectSessionInUrl: false, persistSession: true, autoRefreshToken: true } });
  ...
  async function runVisionRead() {
    ...
    try {
      ...
      console.error('vision read error', error);
